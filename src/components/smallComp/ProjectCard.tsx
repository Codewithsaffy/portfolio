        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            {data.icons.map((icon, i) => (
              <div
                key={i}
                className="rounded-full bg-gray-800/30 w-8 h-8 flex justify-center items-center opacity-100" 
              >
          ...
          <div className="flex justify-end items-center gap-2">
            <div className="bg-green-500 p-2 rounded-full hover:scale-105 transition-transform duration-200">
              <Link href={data.gitHub} className="hover:cursor-pointer">
                <FaCode className="text-white" />
              </Link>
            </div>

            <div className="p-2 rounded-full flex justify-center items-center gap-1 text-blue-500 hover:scale-105 transition-transform duration-200">
              <Link
                href={data.link}
