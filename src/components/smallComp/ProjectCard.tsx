      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex justify-end items-center gap-2 ">
            <Link
              className="bg-green-500 p-2 rounded-full hover:cursor-pointer"
              href={data.gitHub}
            >
            ...
            <Link
              href={data.link}
              className="p-2 rounded-full flex justify-center items-center gap-1 text-blue-500 hover:cursor-pointer"
            >
              <p>view</p>
