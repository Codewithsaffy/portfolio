  ...
  return (
    <section className="min-h-screen  w-full mx-auto px-4 md:px-8 lg:px-16 py-12 z-10">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 w-full mb-12">
        {/* Left Section */}
        <div className="col-span-1 bg-gradient-to-r from-[#0C0E23] to-[#1A1C31] relative lg:col-span-7 w-full h-full md:h-96 lg:h-[480px] rounded-2xl shadow-lg p-8 flex flex-col gap-6">
          <h2 className="text-4xl font-bold text-white z-10">
            About <span className="text-[#CBACF9]">Us</span>
          </h2>
          <p className="text-lg z-10 text-gray-400 leading-relaxed lg:tracking-wide">
        ...
        <div className="col-span-1 lg:col-span-5 flex flex-col gap-8">
          <div className="h-56 lg:h-[225px] rounded-2xl bg-gradient-to-r from-[#0C0E23] to-[#1A1C31] shadow-lg p-8 flex flex-col justify-between relative">
          ...
          <div className="h-56 lg:h-[225px] rounded-2xl bg-gradient-to-r from-[#0C0E23] to-[#1A1C31] shadow-lg p-8 flex z-10 items-center gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="col-span-1 lg:col-span-4 flex flex-col gap-8">
          <div className="h-48 lg:h-[150px] rounded-2xl bg-gradient-to-r from-[#0C0E23] to-[#1A1C31] shadow-lg p-8 relative">
          ...
          <BackgroundGradientAnimation className="flex flex-col items-center justify-center h-48 p-8  rounded-2xl shadow-lg">
            <h2 className="text-xl font-bold text-center text-white">
              Want to start a project together?
            </h2>
            <div className="flex items-center gap-4 py-2 px-4 bg-black/80 rounded-lg mt-4">
              <p className="text-[#CBACF9]">Copy my email address</p> <FaCopy />
            </div>
          </BackgroundGradientAnimation>
        </div>

        <div className="col-span-1 lg:col-span-8 flex flex-col justify-center overflow-hidden h-[200px] md:h-[334px] rounded-2xl bg-gradient-to-r from-[#0C0E23] to-[#1A1C31] shadow-lg relative">
